...
public class EnterUser {
    ...
    public String execute(Admin admin, EnterUserRequest request) {
        Waiting waiting = waitingRepository.findById(request.waitingId()).orElseThrow(WaitingNotFoundException::new);
